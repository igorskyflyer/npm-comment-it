...
Hello, thank you for using CommentIt!! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-comment-it/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-comment-it/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-comment-it/issues) using the appropriate issue template and with the label of `bug`,
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-comment-it/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-comment-it/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of CommentIt!:
